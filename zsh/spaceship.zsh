...
SPACESHIP_CHAR_SYMBOL="%F{154}󰠣 󰑃 %f"


# SPACESHIP_GOLF="%F{green} 󰠣 %f"
SPACESHIP_GOLF=""
...
SPACESHIP_BATTERY_SYMBOL_DISCHARGING="󰁺 "
...
# SPACESHIP_TIME_PREFIX='󰠣 '
SPACESHIP_EXEC_TIME_PREFIX='%F{$SPACESHIP_TIME_COLOR}󱎫' # \ufa1a
