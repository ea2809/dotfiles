# Generated by Powerlevel11k configuration wizard on 2020-08-16 at 16:50 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%F{154}%k%f %F{154}󰠣 󰑃 %f'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='%F{red}%k%f %F{154}󰠣 󰑃 %f'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='%F{blue}%k%f %F{154}󰠣 󰑃 %f'

  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{154}%k%f %F{154}󰠣 %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND}󰑃 %f'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%F{red}%k%f %F{154}󰠣 %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND}󰑃 %f'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%F{blue}%k%f %F{154}󰠣 %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_FOREGROUND}󰑃 %f'
