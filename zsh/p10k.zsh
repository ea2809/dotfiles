# Generated by Powerlevel10k configuration wizard on 2020-08-16 at 16:50 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%F{154}%k%f %F{154}ﴡ 壟%f'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='%F{red}%k%f %F{154}ﴡ 壟%f'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='%F{blue}%k%f %F{154}ﴡ 壟%f'

  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{154}%k%f %F{154}ﴡ %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_FOREGROUND}壟%f'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%F{red}%k%f %F{154}ﴡ %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND}壟%f'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%F{blue}%k%f %F{154}ﴡ %f%F{$POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_FOREGROUND}壟%f'
...
# SPACESHIP_VI_MODE_NORMAL="%F{red}%k%f $SPACESHIP_GOLF" # \uf023
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=always
	# TODO: try it again in the near future
